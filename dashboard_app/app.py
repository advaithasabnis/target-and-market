...
ABOUT_THE_PROJECT = """
Target and Market provides the best candidates for a marketing campaign for an investment tracker mobile application with a fremium model.
    ...
    [
        ...
        html.Div(
            [
                ...
                html.H3('Optimize your marketing campaign', id='tagline')
            ],
            id='title_bar',
            className='topnav'
        ),
            ...
            [
                ...
                html.Div(
                    [
                        html.Div(
                            [
                                html.H3('Characteristics of selected users')
                            ],
                            className='subtitle'
                        )
                    ],
                ...
                html.Div(
                    [
                        html.Div(
                            [
                                html.H3('Characteristics of segments')
                            ],
                            className='subtitle'
                        )
                    ],
...
def update_clusters(user_slider):
    ...
    c1 = f'Segment with {cluster_info.loc[1, "size"]} users. Characterized by a high average session time ({cluster_info.loc[1, "avg_session"]:.0f} secs) compared to the rest.'
    c2 = f'Segment with {cluster_info.loc[2, "size"]} users. Characterized by a high number of active days ({cluster_info.loc[2, "active_days"]:.0f}) compared to the rest.'
    c3 = f'Segment with {cluster_info.loc[3, "size"]} users. Characterized by a high value of investments ({cluster_info.loc[3, "holdings"]:,.0f}) compared to the rest.'
    c4 = f'Segment with {cluster_info.loc[4, "size"]} users. Characterized by relatively low values of all three metrics.'
