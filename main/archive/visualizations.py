...
#%% Log
lr = LogisticRegression(C=0.4, solver='saga', class_weight='balanced', max_iter=400)
...
# X_full = pd.DataFrame(data=X_full, columns=features)
# 
# catb = cb.CatBoostClassifier(depth=4, learning_rate=0.065, l2_leaf_reg=1, iterations=50, cat_features=['continent'])
# 
